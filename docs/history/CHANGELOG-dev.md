...
This is the change log of LeanAPI's development before its first public release, v0.1.0 (2026-09-24). The version numbers below (0.1.0 to 0.6.0) were development milestones. Their tags were retired when v0.1.0 was released, and they don't correspond to the public v0.1.0. Much of this work (typed endpoints over LeanDB, the property library, proofs about APIs) will be introduced in later releases.
